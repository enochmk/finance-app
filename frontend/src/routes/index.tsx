    ...
    <main className="w-full px-4 py-8 lg:px-8 xl:px-10">
      <Card className="relative overflow-hidden border-none bg-[linear-gradient(135deg,rgba(23,107,108,0.95),rgba(10,32,39,0.94))] text-white shadow-[0_30px_70px_rgba(15,23,42,0.25)]">
        ...
        <CardContent className="relative grid gap-10 p-8 lg:grid-cols-[1.2fr_0.8fr] lg:p-10">
          <div>
            <Badge className="mb-4 bg-white/12 text-white hover:bg-white/12">shadcn-style workspace</Badge>
            ...
            {[
              {
                ...
                description: 'Dashboard and report screens now read directly from the backend endpoints.',
              },
              {
                icon: ShieldCheck,
                title: 'Protected insights',
                description: 'Seed-user login drives authenticated views while the app is still in local build mode.',
              },
              {
                icon: BarChart3,
                title: 'Reporting layer',
                description: 'Daily cash flow, category ranking, and account movement are ready for iteration.',
              },
            ].map((item) => {
      ...
      <div className="mt-6 grid gap-4 xl:grid-cols-3">
        <Card className="xl:col-span-2">
          <CardHeader>
            ...
            <CardDescription>Fast local loop for your personal finance build.</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Built around the left sidebar admin layout.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-3">
            {[
              ...
              return (
                <div key={item.label} className="flex items-center gap-3 rounded-xl border border-[var(--border)] px-3 py-3">
